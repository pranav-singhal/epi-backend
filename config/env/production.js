 ...
 */
 ...
 module.exports = require('env-lift').load('wallet-api', {
  ...
  datastores: {
    ...
    default: {
      ...
      host: 'wallet-api-dev.c5g8rodyzt7b.us-west-2.rds.amazonaws.com',
      user: 'postgres',
      password: 'Hello123!',
      database: 'wallet_api'
  ...
  chains: {
    sepolia: {
      gateway: {
        contract: {
          address: '0x18c66249526569f93b45e3749ABc90Ea6BBACfBE',
          admin: {
            pvtkey: ''
          }
        }
